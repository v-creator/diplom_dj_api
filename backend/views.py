...
class AccountDetails(APIView):
  """
    Класс для работы над данными пользователя
    """
...
class PartnerUpdate(APIView):
  ...
  def post(self, request, *args, **kwargs):
    ...
    try:
      ...
      shop, _ = Shop.objects.get_or_create(name=json_data['shop'],
      ...
      return JsonResponse(
          {'error': 'All required arguments were not specified'},
